    ...
    def randomize_styling(self):
        ...
        if self._randomize_styling:
            self.style_attributes = {
                "color": fake.color(
                    hue=random.choice(["blue", "monochrome", "red", "green"]),
                    luminosity="dark",
                ),
...
class Button(HTML5BaseElement):
    ...
    def add_formenctype(self):
        ...
        self.add_unnecessary_html_attribute(
            "formenctype", random.choice(possible_values), 50
        )
...
class RadioButtonsGroup(HTML5BaseElement):
    ...
    def add_specific_attributes(self):
        super().add_specific_attributes()
        specific_attributes = {"name": {generate_uuid()}}
        self.html_attributes.update(specific_attributes)
...
class Table(HTML5BaseElement):
    ...
    def markup(self):
        ...
        elements_in_table = [
            random.choice(available_elements)().markup()
...
class TextField(HTML5BaseElement):
    ...
    def add_specific_attributes(self):
        ...
        self.add_unnecessary_html_attribute(
            "spellcheck", random.choice(["true", "false", ""]), 10
        )
...
class TextArea(HTML5BaseElement):
    ...
    def add_specific_attributes(self):
        ...
        self.add_unnecessary_html_attribute(
            "inner_value", fake.paragraph(nb_sentences=random.randint(5, 15)), 50
        )
        self.add_unnecessary_html_attribute(
            "placeholder", fake.paragraph(nb_sentences=random.randint(1, 3)), 50
        )
        self.add_unnecessary_html_attribute(
            "autocomplete", random.choice(["on", "off"]), 30
        )
        ...
        self.add_unnecessary_html_attribute(
            ...
            random.randint(
                1,
                self.html_attributes["maxlength"]
                if "maxlength" in self.html_attributes
                else 100,
            ),
            30,
        )
        ...
        self.add_unnecessary_html_attribute(
            "spellcheck", random.choice(["true", "false", "default"]), 30
        )
        self.add_unnecessary_html_attribute(
            "wrap", random.choice(["hard", "soft", "off "]), 30
        )
        self.html_attributes.update(specific_attributes)
...
class FileInput(HTML5BaseElement):
    ...
    def add_specific_attributes(self):
        ...
        accept = ",".join(
            [
                f"*.{fake.bothify(text='???', letters=string.ascii_lowercase)}"
        ...
        self.add_unnecessary_html_attribute(
            "capture", random.choice(["user", "environment"]), 15
        )
...
class CheckBox(HTML5BaseElement):
    ...
    def __init__(self, randomize_styling=True, **kwargs):
        ...
        self.add_unnecessary_html_attribute("checked", True, 50)
        self.add_unnecessary_html_attribute(
            "indeterminate", random.choice(["true", "false"]), 25
        )
        self.add_label()
...
class ColorPicker(HTML5BaseElement):
    ...
    def add_specific_attributes(self):
        super().add_specific_attributes()
        specific_attributes = {"type": "color"}
        self.html_attributes.update(specific_attributes)
...
class DateTimeInput(HTML5BaseElement):
    ...
    def add_specific_attributes(self):
        ...
        self.add_unnecessary_html_attribute(
            "autocomplete", random.choice(autocomplete_values), 25
        )
    ...
    def generate_values(self):
        ...
        if self.html_attributes["type"] == "time":
            ...
            value_time = self.get_random_time(
                min_time["hour"],
                min_time["minute"],
                max_time["hour"],
                max_time["minute"],
    ...
    def get_random_date(start=None, end=None):
        ...
        random_day = datetime.fromordinal(
            random.randint(start.toordinal(), end.toordinal())
        ).replace(hour=random.randint(0, 23), minute=random.randint(0, 59))
        return random_day
...
class NumberInput(HTML5BaseElement):
    ...
    def add_specific_attributes(self):
        super().add_specific_attributes()
        specific_attributes = {"type": "number"}
        self.html_attributes.update(specific_attributes)
...
class Paragraph(HTML5BaseElement):
    ...
    def add_specific_attributes(self):
        super().add_specific_attributes()
        self.html_attributes["inner_value"] = fake.paragraph(
            nb_sentences=random.randint(5, 15)
        )
...
class Link(HTML5BaseElement):
    ...
    def add_specific_attributes(self):
        ...
        self.add_unnecessary_html_attribute(
            "referrerpolicy", random.choice(referrer_policies), 30
        )
        self.add_unnecessary_html_attribute("rel", random.choice(relationships), 30)
        self.add_unnecessary_html_attribute(
            "target", random.choice(["_self", "_blank", "_parent", "_top"]), 30
        )
        self.add_unnecessary_html_attribute("rel", random.choice(relationships), 30)
...
class Label(HTML5BaseElement):
    ...
    def add_specific_attributes(self):
        self.html_attributes["inner_value"] = fake.sentence(
        ...
        if generate_text:
            ...
            for _ in range(random.randint(0, 2)):
                self.nested_elements.append(
                    fake.sentence(nb_words=random.randint(1, 2))
                )

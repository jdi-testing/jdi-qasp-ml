...
dataset_path = os.path.join(prefix, "jdi-qasp-ml", "data/bs_dataset")
...
SITE_URLS = [
    "file://" + p
    for p in glob(f'{os.path.join(prefix, "jdi-qasp-ml")}/data/bs_dataset/build/*.html')
]
DATASET_NAMES = ["bs-" + re.search("[0-9]+.html", nm)[0][:-5] for nm in SITE_URLS]
